              ...
              <ProjectSectionText>
                <ul>
                  <li>
                    ...
                    looked back. I've also created <Link href="">a few plugins</Link> that
                    you can install.
                  </li>
                  <li>
            ...
            <ProjectTextRow stretch width="m">
              ...
              <Table>
                <TableRow>
                  ...
                  <TableCell>Core I5 8600</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>
                    <strong>GPU</strong>
                  </TableCell>
                  <TableCell>MSI Gaming X GTX 1060</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>
                    <strong>Memory</strong>
                  </TableCell>
                  <TableCell>GSkill 16GB DDR4 3200mhz </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>
                    <strong>Motherboard</strong>
                  </TableCell>
                  <TableCell>ASUS ROG STRIX B360-F GAMING</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell>2020 Macbook M1 Pro</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>
